...
<html>
    <head>
        <title>Gutachten Blunk</title>
        <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        <meta name=viewport content="width=device-width, initial-scale=1">
        <meta name=description content="Gutachtenpraxis für Psychosomatische Medizin" />
        <meta name=keywords content="Gutachten Blunk" />
            ...
            function initialize() {
              ...
              position: google.maps.ControlPosition.TOP_LEFT,}                              
                  ...
                  var content4 =
                    ...
                    '<div id="siteNotice">'+
                    '</div>'+
                    '<h1 id="firstHeading" class="firstHeading">Kollegienwall 3-4</h1>'+
                    '</div>';
                  var content5 =
                    '<div id="icontent">'+
                    '<div id="siteNotice">'+
    ...
    <?php include_once("analyticstracking.php") ?>
        <header id="navbar" class="skel-layers-fixed">
            <nav id="nav">
                <ul>
                    <li><a itemprop="url" href="#start" id="start-link" class="skel-layers-ignoreHref"><span>Start</span></a></li>
                    <li><a itemprop="url" href="#diagnostik" id="diagnostik-link" class="skel-layers-ignoreHref"><span>Diagnostik</span></a></li>
                    <li><a itemprop="url" href="#behandlung" id="behandlung-link" class="skel-layers-ignoreHref"><span>Behandlung</span></a></li>
                    <li><a itemprop="url" href="#begutachtung" id="begutachtung-link" class="skel-layers-ignoreHref"><span>Begutachtung</span></a></li>
                    <li><a itemprop="url" href="#vita" id="vita-link" class="skel-layers-ignoreHref"><span>Vita</span></a></li>
                    <li><a itemprop="url" href="#standorte" id="standorte-link" class="skel-layers-ignoreHref"><span>Standorte</span></a></li>
                    <li><a itemprop="url" href="#kontakt" id="kontakt-link" class="skel-layers-ignoreHref"><span>Kontakt</span></a></li>
                </ul>
            </nav>
        </header>
        <!-- Main -->
        <div id="main">
            <section id="start" class="one cover">
                <div id ="topbar"></div>
                <!-- Header -->
                <div class="container" itemscope itemtype="http://schema.org/Thing">
                    <header>
                        <h2 class="alt">Dr. med. <span itemprop="name">Ralph Blunk</span></a></h2>
            ...
            <!-- Diagnostik -->
            <section id="diagnostik" class="two">
                <div class="bgj">
                    <div class="container">
                        <header>
                            <h2>Diagnostik</h2>
            ...
            <!-- Behandlung -->
            <section id="behandlung" class="three">
                <div class="bgj">
                    <div class="container">
                        <header>
                            <h2>Behandlung</h2>
            ...
            <!-- Begutachtung -->
            <section id="begutachtung" class="four">
                <div class="bgj">
                    <div class="container">
                        <header>
                            <h2>Begutachtung</h2>
                        ...
                        <p>Im Auftrag von Gerichten, Privatpersonen und Versicherungen in diversen Rechtsgebieten.<br />
                            ...
                            Bewährte Zusammenarbeit mit Ärzten verschiedener Fachrichtungen. <br />
                            Für die testpsychologische Diagnostik besteht eine Kooperation mit Frau Dipl.-Psych. Dr. phil. Eva Richter. 
                        </p>
                    </div>
                </div>
            </section>
            <!-- Vita -->
            <section id="vita" class="five">
                <div class ="bgj">
                    <div class="container">
                        <header>
                            <h2>Vita</h2>
            ...
            <!-- Standorte -->
            <section id="standorte" class="six">
                <div class ="bgj">
                    <div class="container" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
                        ...
                        <h3 itemprop="streetAddress">Klosterstraße 33/34, 48143 Münster.</h3>
                        <div id="map-canvas"></div>
                        <h3 itemprop="streetAddress">Kollegienwall 3-4, ab 01.04.2015 Neumarkt 1, 49074 Osnabrück.</h3>
                        <div id="map-canvas2"></div>
                    </div>
                </div>
            </section>
            <!-- Kontakt -->
            <section id="kontakt" class="seven">
                <div class ="bgj">
                    <div class="container" itemscope itemtype="http://schema.org/Place">
                        <header>
                            <h2>Kontakt</h2>
                        </header>
                        <p itemprop="telephone">Telefon Münster: 0177 3590901</br>
